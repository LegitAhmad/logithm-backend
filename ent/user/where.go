...
func HasMembershipsWith(preds ...predicate.CourseMembership) predicate.User {
	return predicate.User(func(s *sql.Selector) {
...
// HasOwnedCourses applies the HasEdge predicate on the "owned_courses" edge.
func HasOwnedCourses() predicate.User {
	return predicate.User(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
...
// HasOwnedCoursesWith applies the HasEdge predicate on the "owned_courses" edge with a given conditions (other predicates).
func HasOwnedCoursesWith(preds ...predicate.Course) predicate.User {
	return predicate.User(func(s *sql.Selector) {
		step := newOwnedCoursesStep()
		sqlgraph.HasNeighborsWith(s, step, func(s *sql.Selector) {
			for _, p := range preds {
				p(s)
			}
