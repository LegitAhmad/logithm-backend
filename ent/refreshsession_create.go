...
func (_c *RefreshSessionCreate) SetSessionID(v string) *RefreshSessionCreate {
	_c.mutation.SetSessionID(v)
	return _c
}

// SetFamilyID sets the "family_id" field.
func (_c *RefreshSessionCreate) SetFamilyID(v string) *RefreshSessionCreate {
...
func (_c *RefreshSessionCreate) check() error {
	if _, ok := _c.mutation.SessionID(); !ok {
		return &ValidationError{Name: "session_id", err: errors.New(`ent: missing required field "RefreshSession.session_id"`)}
	}
	if _, ok := _c.mutation.FamilyID(); !ok {
		return &ValidationError{Name: "family_id", err: errors.New(`ent: missing required field "RefreshSession.family_id"`)}
	}
...
func (_c *RefreshSessionCreate) createSpec() (*RefreshSession, *sqlgraph.CreateSpec) {
	...
	if value, ok := _c.mutation.SessionID(); ok {
		_spec.SetField(refreshsession.FieldSessionID, field.TypeString, value)
		_node.SessionID = value
	}
	if value, ok := _c.mutation.FamilyID(); ok {
		_spec.SetField(refreshsession.FieldFamilyID, field.TypeString, value)
